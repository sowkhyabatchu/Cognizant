...
## Notes
- Run these commands from the project folder containing `StoreManagement.csproj.`.
...
- The `InventoryDbContext` class manages the database connection and maps the entity classes to their corresponding SQL Server tables.
