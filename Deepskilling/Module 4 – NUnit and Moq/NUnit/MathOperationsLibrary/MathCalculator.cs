...
namespace MathOperations.Tests
{
    ...
    public class MathCalculatorTests
    {
        ...
        /// MathCalculator instance so each test starts clean.
        /// </summary>
        [SetUp]
        public void SetUp()
        {
            _calculator = new MathCalculator();
            TestContext.WriteLine("SetUp: MathCalculator instance created.");
        }
        ...
        {
            _calculator = null;
            TestContext.WriteLine("TearDown: MathCalculator instance disposed.");
        }
