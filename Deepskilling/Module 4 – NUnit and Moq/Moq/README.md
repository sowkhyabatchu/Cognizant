...
├── CustomerCommunication.sln
├── CustomerCommunicationLibrary/
│   ├── CustomerCommunicationLibrary.csproj
│   ├── IEmailService.cs          ← Interface
│   ├── EmailService.cs           ← Real SMTP implementation
│   └── CustomerNotification.cs   ← Class Under Test
└── CustomerCommunication.Tests/
    ├── CustomerCommunication.Tests.csproj
    └── CustomerNotificationTests.cs
```
